...
#ifdef DEBUG
	    printf("dmu_objset_open_impl::&osi->os_dirty_dnodes[i]=0x%x\n", 
		   &osi->os_dirty_dnodes[i]);
#endif
...
#ifdef DEBUG
	    printf("dmu_objset_sync::&os->os_free_dnodes[txgoff]=0x%x\n", 
		   &os->os_free_dnodes[txgoff]);
#endif
